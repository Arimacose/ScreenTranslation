...
> The v2.0.0 release candidate includes three switchable visual languages: an Apple-inspired default,
...
> Project status: `v2.0.0` release candidate for one explicitly scoped device/ROM baseline.
...
[`docs/DEVICE_TEST.md`](docs/DEVICE_TEST.md); final candidate measurements will be added before release.
