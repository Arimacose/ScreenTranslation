...
- Deterministic recovery for high-confidence sentence endings, hard-line boundaries, and
  missing closing punctuation; URLs, email addresses, dates, amounts, decimals, and versions
