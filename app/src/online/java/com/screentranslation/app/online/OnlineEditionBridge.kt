...
object OnlineEditionBridge {
    @JvmStatic
    fun isConfigurationReady(context: Context): Boolean = runCatching {
        OnlineTranslationConfigRepository(context.applicationContext).requireReady()
    }.isSuccess
    ...
    fun configurationSummary(context: Context): String {
        ...
        return context.getString(
            ...
            context.getString(R.string.online_mode_user_api),
            host,
            model,
            keyState,
        )
