...
class ModelBenchmarkActivity : Activity() {
        ...
        Thread(
            {
                ...
                runCatching {
                    ...
                    Log.i(TAG, "Benchmark complete: ${outputDirectory.resolve(RESULT_FILE)}")
                }.onFailure { error ->
    ...
    private fun runBenchmark(outputDirectory: File) {
        val ocrEngine = OcrEngine(SOURCE_LANGUAGE)
        ...
        try {
            ...
            awaitTranslation(translationEngine, "Warm-up sentence.")
            ...
            val result = JSONObject()
                ...
                .put(
                    "engines",
                    JSONObject()
                        .put("ocr", "ML Kit Text Recognition Latin 16.0.1")
            ...
            outputDirectory.resolve(RESULT_FILE).writeText(
                result.toString(2),
                Charsets.UTF_8,
            )
        } finally {
    ...
    private companion object {
        ...
        const val RESULT_FILE = "baseline-mlkit.json"
