...
| AndroidX WorkManager Runtime KTX | 2.11.2 | Apache License 2.0 |
| Material Components for Android | 1.14.0 | Apache License 2.0 |
| ONNX Runtime for Android | 1.29.0 | MIT License |
...
- [ONNX Runtime 1.29.0](https://github.com/microsoft/onnxruntime/tree/v1.29.0)
- [ONNX Runtime 1.29.0 third-party notices](https://github.com/microsoft/onnxruntime/blob/v1.29.0/ThirdPartyNotices.txt)
...
- ONNX Runtime 1.29.0 MIT 全文；
- ONNX Runtime 1.29.0 官方 `ThirdPartyNotices.txt`；
